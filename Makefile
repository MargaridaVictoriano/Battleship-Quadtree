...
quad: battleship.c global_var.h coords.h boat.h board.h utils.h cell.h point.h qtree.h
	$(CC) battleship.c global_var.c coords.c boat.c board.c utils.c cell.c point.c qtree.c $(CFLAGS) $(QUAD) $(LDFLAGS) -o battleship

matrix: battleship.c global_var.h coords.h boat.h board.h utils.h cell.h
